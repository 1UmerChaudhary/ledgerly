...
void main() {
  testWidgets('typing shows fuzzy matches; Enter picks the highlighted one and reports it', (tester) async {
    String? picked;
    ...
    await tester.sendKeyEvent(LogicalKeyboardKey.arrowDown, platform: 'windows');
    await tester.pumpAndSettle();
