...
void main() {
  ...
  group('the four spec rules fall out of one signed balance', () {
    ...
    test(
      '2. purchase consumes a receivable first, remainder becomes giveable',
      () {
        final b = applyTransaction(
          Money.rupees(3000),
    ...
    test(
      '3. cash received with no receivable becomes an advance (giveable)',
      () {
        final b = applyTransaction(
          Money.zero,
