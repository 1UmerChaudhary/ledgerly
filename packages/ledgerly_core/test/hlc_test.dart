...
void main() {
  group('Hlc — timestamps that never go backwards on a device', () {
    ...
    test('is seeded from the newest stamp already in the database', () {
      final hlc = Hlc(clock: () => 1000, seed: 7000);
    ...
    test(
      ...
      () {
        final hlc = Hlc(clock: () => 1000, seed: 99999999);
        hlc.reseed(2000);
